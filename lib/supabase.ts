...
export const supabaseUrl = 'https://ctulmpyaikxsnjqmrzxf.supabase.co';
...
// AsyncStorage acessa `window` internamente; em SSR (expo-router web output "static") não existe window.
const noopStorage = {
  getItem: async () => null,
  setItem: async () => {},
  removeItem: async () => {},
